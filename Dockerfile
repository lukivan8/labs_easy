...
ARG BUILDER_IMAGE="elixir:1.16.2-otp-26-slim"
ARG RUNNER_IMAGE="elixir:1.16.2-otp-26-slim"
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/labs_easy ./
